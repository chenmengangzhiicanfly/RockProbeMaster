...
private slots:
    ...
    void openWorkspaceTable(QString table,QString path);
...
//    void on_action_main_triggered();
    ...
    void currentWorkspaceChange(QString table,QStandardItem* item);
    void closeWorkspace();
    void on_pushButton_5_clicked();

    void unqualifiledVideoExcel(QString workspacelist);
    void allWorkSpaceVideoExcel(QString workspacelist);
    void inspectorUnqualifiledVideoExcel(QString workspacelist);
    void videoByDateExcel(QString workspacelist);

    void filterInit();
    bool eventFilter(QObject* obj,QEvent* event);
    void workspaceFilterInit(QString workspaceName);
    void filterItemInit(QString filterItem,QString databaseItem);
